...
Create a note manually, from a recording, or from captured photos.
Store notes with course, content, tags, summaries, audio, images, knowledge points, and practice questions.
Use the Doubao API to summarize note content, extract knowledge points, and generate exercises.
Browse note cards, open note detail pages, review generated material, and practice quiz questions.
Current structure
D:\222
  .gitignore
  REMIND_ME.md
